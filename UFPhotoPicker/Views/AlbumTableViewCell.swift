...
class AlbumTableViewCell: UITableViewCell {
    ...
    var isDarkStyle = false {
        didSet {
            self.contentView.backgroundColor = isDarkStyle ? UIColor(hexColor: "#1F1F22") :.white
            titleLabel.textColor = isDarkStyle ? .white:UIColor(hexColor: "#1F1F22")
            countLabel.textColor = isDarkStyle ? .lightGray:UIColor(hexColor: "#666666")
        }
    }
